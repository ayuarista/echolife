...
const OurMissions = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6" data-aos="fade-right">
            <div data-aos="fade-down">
              ...
              <h1 className="text-3xl lg:text-[32px] font-bold text-secondary dark:text-primary mt-2">
                Our Mission for  {" "}
                   <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-hero">
               a Greener Planet
              </span>
              </h1>
              <div className="font-Poppins text-sm lg:text-[15px] md:text-[15px] mt-2 max-w-lg text-justify leading-relaxed text-gray-500 dark:text-white">
            ...
            {/* Rating & Reviews */}
            <div className="flex items-center gap-6" data-aos="fade-up" data-aos-delay="100">
  ...
  <HashLink smooth to="/3r">
    <button className="group px-5 py-2.5 bg-primary hover:bg-primary/60 dark:bg-hero dark:hover:bg-hero/60 text-white dark:text-base-300 rounded-full transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl">
      ...
      Learn more
          ...
          <div className="relative" data-aos="fade-left">
            <div className="relative">
              {/* Main Image */}
              <div className="relative h-[27rem] rounded-3xl overflow-hidden shadow-2xl" data-aos="zoom-in">
                <img
                  src="https://images.unsplash.com/photo-1649577193391-f13d769d011d?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="mission"
