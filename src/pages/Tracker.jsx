    ...
    <div className="pt-24 min-h-screen w-full bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-2">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          ...
          <button
            onClick={onTrack}
            className="w-full sm:w-auto inline-flex justify-center items-center gap-2 px-5 py-3 rounded-2xl bg-primary text-white dark:bg-hero dark:text-slate-900 hover:opacity-90 transition font-semibold"
          >
            Track Waste
          </button>
        </div>
      ...
      {showPanel && (
        <section className="mx-auto max-w-6xl px-4 py-8 md:py-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Chart Card */}
          <div className="chart-card rounded-2xl border border-slate-200 dark:border-slate-800 p-5 bg-white dark:bg-slate-950 lg:col-span-2">
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-slate-800 p-5 bg-white dark:bg-slate-950">
            ...
            <div className="mt-5 flex gap-2">
              <button
                ...
                className="px-4 py-2 rounded-xl border border-primary dark:border-green-700 text-primary dark:text-hero hover:bg-green-50/40 dark:hover:bg-green-950/20 font-semibold transition-colors"
              >
                Reset
              </button>
              <button
                onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
                className="px-4 py-2 rounded-xl bg-primary dark:bg-hero text-white dark:text-slate-900 font-semibold hover:opacity-90 transition"
              >
                Edit Inputs
              </button>
            </div>
